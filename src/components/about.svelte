<div class="container wwwwwh">
	...
	<ul>
		...
		<li>Tier 2 = Next 1000 buyers - 2 DIGITAL ASSETS/NFTs</li>
		<li>Tier 3 = Everyone else - 1 DIGITAL ASSET/NFT</li>
	</ul>

	<p>
		*Please note that all tiers will be priced at the same amount. Tiers will prioritize how early
		you got to the party, not how much you paid to get in.
	</p>
	...
	<p>
		Consumption and creation of art is booming with the recent NFT craze. While it does a great job
		empowering artists, there is a massive barrier to entry with high costs and fees. Film and TV
		are an art form of the masses, and our goal is to price our content as such. Through
		tokenization, we want to change how content is experienced. This project bridges the gap between
		entertainment and crypto while also taking a step closer to hyperbitcoinization.
	</p>
